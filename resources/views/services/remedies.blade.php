                ...
                <div class="row mb-4 wow fadeIn">
                    ...
                    <div class="col-lg-6 col-md-3 mb-4 serviceform">
                        ...
                        <form class="card" action="/horoscope" enctype="multipart/form-data" method="post" style="width: 100%;">
                            @csrf
                            <h5 class="my-3  py-2 text-uppercase text-white" style="background-color:#f05f1e;"> Remedies</h5>
                            ...
                            <div class="card-body mx-4">
                                ...
                                <div class="col-sm-12 md-4 text-center formbutton">
                                    <p class="  my-2"> Detailed Report :  1200/-</p>

                                    <button type="submit"  name="submit" data-amount="1000"  class="btn md-3 text-white btn-md">Submit Details</button>
                                </div>
                            </div>
                        </form>
                        <!--/.Card-->
