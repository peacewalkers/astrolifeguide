    ...
    <div class="container text-center text-dark text-md-left mt-5">
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                ...
                <!-- Content -->
                <h6 class="text-uppercase font-weight-bold" style="color: #038C01 "><img src="<?php echo e(asset('astrolifeguide')); ?>/img/header/logo.png" width="250" style="margin-top:-14px; margin-left:-10px;"></h6>
